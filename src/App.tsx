        ...
        <div className="mx-auto max-w-7xl rounded-full border border-white/12 bg-[#08172e]/78 px-4 py-3 shadow-[0_18px_40px_rgba(0,0,0,0.24)] backdrop-blur-xl sm:px-6">
          <div className="flex items-center justify-between gap-4">
            <a href="#inicio" className="flex min-w-0 items-center gap-3" onClick={closeMenu}>
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,#1666D8_0%,#77C8FF_100%)] text-lg font-black text-white shadow-[0_12px_24px_rgba(22,102,216,0.38)]">
                C
              </div>
        ...
        <section className="bg-white py-20 sm:py-24">
          <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
            <div className="reveal relative overflow-hidden rounded-[2rem] border border-slate-200 bg-[linear-gradient(160deg,#0A2044_0%,#1666D8_100%)] p-8 text-white shadow-[0_28px_80px_rgba(8,34,71,0.18)]" data-reveal>
              ...
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-white/14 text-2xl shadow-[0_10px_30px_rgba(0,0,0,0.14)]">
                ⚠
              </div>
              <h2 className="mt-6 text-3xl font-extrabold tracking-tight sm:text-4xl">O barato pode sair muito caro.</h2>
              ...
              {galleryItems.map((item, index) => (
                ...
                >
                  <div className="relative aspect-[4/5] overflow-hidden">
                    ...
                    <div className="absolute inset-x-0 bottom-0 bg-[linear-gradient(180deg,transparent,rgba(8,34,71,0.92))] p-5 text-white">
                      <h3 className="text-lg font-extrabold">{item.title}</h3>
                    </div>
                  </div>
                </article>
        ...
        <section id="contato" className="scroll-mt-28 bg-[linear-gradient(135deg,#071731_0%,#082247_45%,#1666D8_100%)] py-20 text-white sm:py-24">
          <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.02fr_0.98fr] lg:px-8">
            <div className="reveal" data-reveal>
              ...
              <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                <a href="tel:+5521974802369" className={buttonPrimary}>
                  Agendar Avaliação Técnica
                </a>
                <a href="https://instagram.com/clemat_climatizacao" target="_blank" rel="noreferrer" className={buttonSecondary}>
            ...
            <div className="reveal rounded-[2rem] border border-white/12 bg-white/10 p-6 shadow-[0_28px_80px_rgba(0,0,0,0.22)] backdrop-blur-xl" data-reveal>
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-[1.5rem] border border-white/12 bg-[#082247]/38 p-5">
                  ...
                  <a href="tel:+5521974802369" className="mt-3 block text-2xl font-extrabold text-white">
                    (21) 97480-2369
                  </a>
                ...
                <div className="rounded-[1.5rem] border border-white/12 bg-[#082247]/38 p-5">
                  ...
                  <a
                    href="https://instagram.com/clemat_climatizacao"
                    target="_blank"
                    rel="noreferrer"
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr_0.8fr] lg:px-8">
          <div>
            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,#1666D8_0%,#77C8FF_100%)] text-lg font-black text-white shadow-[0_12px_24px_rgba(22,102,216,0.28)]">
                C
              </div>
              <div>
                <div className="font-display text-lg font-extrabold tracking-[0.18em] text-white">CLEPAT</div>
          ...
          <div>
            ...
            <div className="mt-4 space-y-3 text-sm font-semibold">
              <a href="https://instagram.com/clemat_climatizacao" target="_blank" rel="noreferrer" className="block transition hover:text-white">
                @clemat_climatizacao
              </a>
              <a href="tel:+5521974802369" className="block transition hover:text-white">
                (21) 97480-2369
              </a>
